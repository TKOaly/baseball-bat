  ...
  return (
    <Page>
      ...
      <Section title="Details" columns={2}>
        <TextField label="Start Date" value={format(parseISO(statement.openingBalance.date as string), 'dd.MM.yyyy')} />
        <TextField label="Opening Balance" value={formatEuro(statement.openingBalance.amount)} />
        <TextField label="End Date" value={format(parseISO(statement.closingBalance.date as string), 'dd.MM.yyyy')} />
        <TextField label="Closing Balance" value={formatEuro(statement.closingBalance.amount)} />
