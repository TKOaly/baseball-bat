    ...
    <DialogBase onClose={() => onClose(null)}>
      ...
      <DialogContent>
        ...
        <div className="flex items-center mb-4">
          ...
          />
          <label htmlFor="send-reminders-dialog-cooldown-checkbox" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ignore notice cooldown (1 month)</label>
        </div>
        <div className="flex items-center">
          ...
          />
          <label htmlFor="send-reminders-dialog-send-checkbox" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Save messages as drafts</label>
        </div>
      </DialogContent>
      <DialogFooter>
